...
public class hkbnkd {
	...
	Logger logger = (Logger) LogManager.getLogger("hkbnkd");
	...
	public static void initialiseExtentReports() {
	    if(extentReports == null) {
	        ExtentSparkReporter sparkReporter_all = new ExtentSparkReporter("./Report/Pawar.html");
	        ...
	        ExtentSparkReporter sparkReporter_failed = new ExtentSparkReporter("./Report/Rathod.html");
